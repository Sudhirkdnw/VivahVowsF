  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100">
      <div className="flex min-h-screen">
        <aside className="w-72 bg-white/70 backdrop-blur-lg border-r border-white/40 shadow-xl p-8 flex flex-col">
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          <div className="bg-white/40 backdrop-blur rounded-3xl border border-white/60 shadow-lg p-6">
